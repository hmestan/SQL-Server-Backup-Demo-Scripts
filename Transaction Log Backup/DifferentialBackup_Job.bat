...
REM    Örnek: SQLCMD -S .\SQLExpress -U sa -P MyPassword -i "C:\Backup\Full_Backup_Differential.sql"
REM
...
REM    Example: SQLCMD -S .\SQLExpress -U sa -P MyPassword -i "C:\Backup\Full_Backup_Differential.sql"
REM
...
SQLCMD -S .\SQLExpress -E -i "C:\Backup\Full_Backup_Differential.sql"
