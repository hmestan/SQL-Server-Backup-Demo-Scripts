...
REM    Örnek: SQLCMD -S .\SQLExpress -U sa -P MyPassword -i "C:\Backup\FullBackup_Overwrite.sql"
REM
...
REM    Example: SQLCMD -S .\SQLExpress -U sa -P MyPassword -i "C:\Backup\FullBackup_Overwrite.sql"
REM -----------------------------------------------------------------------------

SQLCMD -S .\SQLExpress -E -i "C:\Backup\FullBackup_Overwrite.sql"
