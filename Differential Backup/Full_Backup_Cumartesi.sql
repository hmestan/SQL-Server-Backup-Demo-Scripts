...
-- 💡 Bu script her çalıştırıldığında, Cumartesi günkü eski yedeği SİLER ve üzerine yazar (overwrite).
--
-- 📂 First, create a folder named "Backup" on your C: drive.
-- 💡 This backup will overwrite  any existing backup file in Saturday .
------------------------------------------------------------------------------------
*/
...
SET @DosyaAdi = N'C:\Yedek\UretimFull_Cumartesi.bak'
SET @YedekAdi = N'Uretim Full Cumartesi Yedek'
